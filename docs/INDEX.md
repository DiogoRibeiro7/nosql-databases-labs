# 📚 MongoDB NoSQL Labs - Documentation Index

Welcome to the comprehensive documentation hub for the MongoDB NoSQL Databases Labs. This index organizes all documentation by audience and purpose.
...
- [**Theory Primers**](theory_primers/) - Visual guides to core concepts
  ...
  - [Indexing Strategies](theory_primers/03_indexing_strategies.md)
  - [Aggregation Patterns](theory_primers/04_aggregation_patterns.md)
...
1. [**Lab 01: Introduction**](../labs/lab01_intro/README.md)
   ...
   - Data import/export
   - [Practice Exercises](../exercises/lab01_intro.md)
   - [Solutions](../exercises/solutions/lab01_intro.md)

2. [**Lab 02: Data Modeling**](../labs/lab02_modeling/README.md)
   - Schema design patterns
   - Embedded vs referenced
   - [Practice Exercises](../exercises/lab02_modeling.md)
   - [Solutions](../exercises/solutions/lab02_modeling.md)

3. [**Lab 03: Advanced Queries**](../labs/lab03_queries/README.md)
   - Complex queries
   - Performance optimization
   - [Practice Exercises](../exercises/lab03_queries.md)
   - [Solutions](../exercises/solutions/lab03_queries.md)

4. [**Lab 04: Aggregation**](../labs/lab04_aggregation/README.md)
   - Pipeline operations
   - Analytics patterns
   - [Practice Exercises](../exercises/lab04_aggregation.md)
   - [Solutions](../exercises/solutions/lab04_aggregation.md)

5. [**Lab 05: Replication**](../labs/lab05_replication/README.md)
   - Replica sets
   - High availability
   - [Practice Exercises](../exercises/lab05_replication.md)
...
- [**Performance Baselines**](performance_baselines.md) - Benchmarks
...
- **Issues**: [GitHub Issues](https://github.com/anthropics/nosql-databases-labs/issues)
- **Discussions**: [GitHub Discussions](https://github.com/anthropics/nosql-databases-labs/discussions)
...
- [→ Start with Lab 01](../labs/lab01_intro/README.md)
- [↑ Top of Page](#-mongodb-nosql-labs---documentation-index)
