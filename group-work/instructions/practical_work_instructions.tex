...
\hline
\textbf{Criterion} & \textbf{Weight} & \textbf{Grade Range} \\
\hline
Functionality (Does it work?) & 40\% & 0-40 points \\
Code Quality (Is it well-written?) & 25\% & 0-25 points \\
Documentation (Is it explained?) & 20\% & 0-20 points \\
Performance (Is it optimized?) & 15\% & 0-15 points \\
\hline
\textbf{Total} & \textbf{100\%} & \textbf{0-100 points} \\
\hline
\end{tabularx}
\caption{Lab Assessment Breakdown}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Office Hours}: Weekly sessions (schedule on LMS)
