...
users.insert({ _id: "ruth", joined: ISODate("2011-01-12"), likes: ["swimmig", "golf", "racquetball"] })
users.insert({ _id: "kate", joined: ISODate("2012-01-23"), likes: ["tennis", "darts"] })
users.insert({ _id: "harold", joined: ISODate("2012-01-15"), likes: ["golf", "basketball", "darts", "tennis"] })
