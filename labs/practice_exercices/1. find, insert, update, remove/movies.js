...
comedy.insert({name: 'Ted', year: 2012, tagline: 'Ted is coming',
...
comedy.insertOne({name: 'We\'re the Millers', year: 2013, tagline: 'If anyone asks',
...
comedy.insertMany([{name: 'The Hangover', year: 2009, tagline: 'Some guys just can\'t handle Vegas',
...
/* Insert a new comedy
    ...
    */
comedy.insert({name: 'Ted 2', year: 2015, tagline: 'Ted is coming again',
    cast: ['Mark Walhlberg', 'Seth MacFarlane', 'Amanda Seyfried', 'Morgan Freeman'],
    technical: {runningTime: 115, language: 'English'}, 
    sequel: 'Ted 2',
    merits: {budget: 85},
...
comedy.find({"merits.boxOffice": {$gt:500}}, {name:true, "merits.boxOffice":true, _id: false})
...
comedy.update({name: /The hangover.*/i}, {'$set': {director:'Todd Phillips'}}, {multi: true})
