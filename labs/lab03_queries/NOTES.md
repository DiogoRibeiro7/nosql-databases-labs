...
Note: On larger datasets (100K+ documents), improvements would be
much more dramatic (100x-1000x faster).
*/
...
This allows scanning ratings from high to low until we find 10
movies meeting year criteria.
*/
