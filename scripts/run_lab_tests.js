...
const labs = [
  ...
  },
  {
    ...
    steps: [
      { title: 'Import modeling fixtures', cmd: 'node', args: ['labs/lab02_modeling/import_data.js'] },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Run data integrity tests', cmd: 'node', args: ['labs/lab03_queries/test_data_integrity.js'] },
    ],
  },
  {
    id: 'lab04',
    ...
    steps: [
      { title: 'Import sales dataset', cmd: 'node', args: ['labs/lab04_aggregation/import_data.js'] },
      { title: 'Run aggregation tests', cmd: 'node', args: ['labs/lab04_aggregation/test_lab04.js'] },
    ],
  },
  {
    id: 'lab05',
    ...
    steps: [
      {
        ...
        skipMessage: 'Replica set not detected (skipping). Run node labs/lab05_replication/setup_replica_set.js first.',
      },
    ],
  },
];
...
async function main() {
  ...
  if (selectedLabs.length === 0) {
    console.error(`Unknown lab identifier "${lab}". Valid ids: ${labs.map(l => l.id).join(', ')}`);
    process.exit(1);
  }
